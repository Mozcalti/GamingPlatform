...
import DashboardParticipanteService from "./DashboardParticipante.service";
...
const DashboardParticipante = () => {
    ...
    const getEtapas = () => {
        DashboardParticipanteService.obtenerEtapas()
            .then(
                (response) => {
    ...
    const getInstitucion = (correo) => {
        ParticipantesService.obtenerInstitucion(correo)
            .then(
                (response) => {
    ...
    useEffect(() => {
        getEtapas()
        getInstitucion(AuthService.getCurrentUser().email)
        ...
        <>
            ...
            <Container fluid>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={2} md={2}>
                        <Button onClick={() => getDashboardGlobal(etapa, institucion)} variant="contained"

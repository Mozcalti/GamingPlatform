...
public class CatalogosController {
    ...
    @GetMapping("/participantes/{idInstitucion}")
    public List<ParticipanteDTO> getParticipantesByIdInstitucion(@PathVariable Integer idInstitucion) {
        return batallasService.getParticipantesByIdInstitucion(idInstitucion);
    }
